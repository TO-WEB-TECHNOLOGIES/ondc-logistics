...
export const ondcTransactions = pgTable("ondc_transactions", {
  ...
  errorCode: varchar("error_code"), errorMessage: varchar("error_message"),
  domain: varchar("domain"), country: varchar("country"), city: varchar("city"),
  coreVersion: varchar("core_version"), bapId: varchar("bap_id"), bapUri: varchar("bap_uri"),
  bppId: varchar("bpp_id"), bppUri: varchar("bpp_uri"),
